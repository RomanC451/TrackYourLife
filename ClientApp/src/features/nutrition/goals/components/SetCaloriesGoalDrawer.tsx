...
import useUpdateCaloriesGoalMutation from "../mutations/useUpdateCaloriesGoalMutation";
import { nutritionGoalsQueryOptions } from "../queries/nutritionGoalsQuery";
...
export const SetCaloriesGoalDrawer = () => {
  ...
  useEffect(() => {
    if (!pendingState.isPending && goals?.calories.value) {
      setValue(goals.calories.value);
    }
  }, [pendingState.isPending, goals?.calories.value]);

  const { setCaloriesGoalMutation, error: mutationError } =
    useUpdateCaloriesGoalMutation();
            ...
            <div className="flex items-center justify-center space-x-2">
              <Button
                ...
                disabled={
                  ...
                  setCaloriesGoalMutation.pendingState.isPending
                }
              >

...
public class TokenQueryTests(DatabaseFixture fixture) : BaseRepositoryTests(fixture)
{
    ...
    public async Task GetByValueAsync_WhenTokenExists_ReturnsToken()
    {
        ...
        {
            // Act
            var result = await _query.GetByValueAsync("test-token-value", CancellationToken.None);
    ...
    public async Task GetByValueAsync_WhenTokenDoesNotExist_ReturnsNull()
    {
        ...
        {
            // Act
            var result = await _query.GetByValueAsync("non-existent-token", CancellationToken.None);
    ...
    public async Task GetByUserIdAndTypeAsync_WhenTokensExist_ReturnsTokens()
    {
        ...
        {
            // Act
            var result = await _query.GetByUserIdAndTypeAsync(
                user.Id,

...
internal sealed class ExerciseHistoryWithOngoingTrainingIdAndNotAppliedSpecification(
...
) : Specification<ExerciseHistory, ExerciseHistoryId>
{
    public override Expression<Func<ExerciseHistory, bool>> ToExpression() =>
        exerciseHistory =>
            exerciseHistory.OngoingTrainingId == ongoingTrainingId
            && !exerciseHistory.AreChangesApplied;
}

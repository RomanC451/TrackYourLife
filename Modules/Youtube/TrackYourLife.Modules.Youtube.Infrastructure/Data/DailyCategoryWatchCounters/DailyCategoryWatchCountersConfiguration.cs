...
internal sealed class DailyCategoryWatchCountersConfiguration
    : IEntityTypeConfiguration<DailyCategoryWatchCounter>
{
    public void Configure(EntityTypeBuilder<DailyCategoryWatchCounter> builder)
    {
        ...
        builder.HasIndex(e => new { e.UserId, e.Date, e.YoutubeCategoryId }).IsUnique();

...
internal sealed class YoutubePlaylistReadModelConfiguration
    : IEntityTypeConfiguration<YoutubePlaylistReadModel>
{
    public void Configure(EntityTypeBuilder<YoutubePlaylistReadModel> builder)
    {

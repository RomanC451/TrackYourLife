...
namespace TrackYourLife.Modules.Youtube.Infrastructure.Migrations
{
    ...
    public partial class AddYoutubeSettingsAndDailyCounter : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WatchedAtUtc = table.Column<DateTime>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    MaxEntertainmentVideosPerDay = table.Column<int>(
                        type: "integer",
                        nullable: false
                    ),
                    ...
                    LastSettingsChangeUtc = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "WatchedVideo", schema: "Youtube");

            migrationBuilder.DropTable(name: "YoutubeSettings", schema: "Youtube");
        }
    }
}

...
namespace TrackYourLife.Modules.Nutrition.Infrastructure.Migrations
{
    ...
    public partial class AddDailyNutritionOverview : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NutritionalContent_Carbohydrates = table.Column<float>(
                        type: "real",
                        nullable: false
                    ),
                    NutritionalContent_Cholesterol = table.Column<float>(
                        type: "real",
                        nullable: false
                    ),
                    ...
                    NutritionalContent_MonounsaturatedFat = table.Column<float>(
                        type: "real",
                        nullable: false
                    ),
                    NutritionalContent_NetCarbs = table.Column<float>(
                        type: "real",
                        nullable: false
                    ),
                    NutritionalContent_PolyunsaturatedFat = table.Column<float>(
                        type: "real",
                        nullable: false
                    ),
                    NutritionalContent_Potassium = table.Column<float>(
                        type: "real",
                        nullable: false
                    ),
                    NutritionalContent_Protein = table.Column<float>(type: "real", nullable: false),
                    NutritionalContent_SaturatedFat = table.Column<float>(
                        type: "real",
                        nullable: false
                    ),
                    ...
                    NutritionalContent_TransFat = table.Column<float>(
                        type: "real",
                        nullable: false
                    ),
                    NutritionalContent_VitaminA = table.Column<float>(
                        type: "real",
                        nullable: false
                    ),
                    NutritionalContent_VitaminC = table.Column<float>(
                        type: "real",
                        nullable: false
                    ),
                    NutritionalContent_Energy_Unit = table.Column<string>(
                        type: "text",
                        nullable: false
                    ),
                    NutritionalContent_Energy_Value = table.Column<float>(
                        type: "real",
                        nullable: false
                    ),
                },
        ...
        {
            migrationBuilder.DropTable(name: "DailyNutritionOverviews", schema: "Nutrition");
        }
    }
}

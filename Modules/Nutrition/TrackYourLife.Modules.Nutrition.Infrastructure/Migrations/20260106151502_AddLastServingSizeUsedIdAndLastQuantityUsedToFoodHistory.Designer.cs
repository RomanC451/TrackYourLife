...
namespace TrackYourLife.Modules.Nutrition.Infrastructure.Migrations
{
    ...
    [Migration("20260106151502_AddLastServingSizeUsedIdAndLastQuantityUsedToFoodHistory")]
    partial class AddLastServingSizeUsedIdAndLastQuantityUsedToFoodHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TrackYourLife.Modules.Nutrition.Domain.Features.FoodsHistory.FoodHistory", b =>
                {
                    ...
                    b.Property<float>("LastQuantityUsed")
                        .HasColumnType("real");

                    b.Property<Guid>("LastServingSizeUsedId")
                        .HasColumnType("uuid");

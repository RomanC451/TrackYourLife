...
public class ChromeCookiesReader(ILogger logger)
{
    ...
    public CookieContainer GetCookies(string[] cookieDOmains)
    {
...
#pragma warning restore CA1416 // Validate platform compatibility
    ...
    private ICollection<Cookie> ReadFromDb(
        string baseFolder,
        byte[] key,
    ...
    )
    {
        ...
        {
            _logger.Error("CookieReader failed readind the cookie file with exception {exception}", exception);
        }
